...
const LABEL_WIDTH = 20; // side label column width in px
...
export function RunHeatmap({ data }: RunHeatmapProps) {
  ...
  const gridCols = `${LABEL_WIDTH}px repeat(${DAYS_TO_SHOW}, 1fr) ${LABEL_WIDTH}px`;
                  ...
                  {row.map((cell, colIdx) => {
                    ...
                    if (!cell) {
                      return (
                        <span
                          key={key}
                          className="border border-transparent aspect-square"
                        />
                      );
                    }
                    ...
                    return (
                      <span
                        ...
                        className="border border-matrix-ghost cursor-default aspect-square"
